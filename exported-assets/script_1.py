...
party_results = {
    'Party': ['BJP', 'JD(U)', 'RJD', 'LJP(RV)', 'INC', 'AIMIM', 'HAM(S)', 'RLM', 'CPI(ML)', 'CPI(M)', 'BSP', 'Jan Suraaj'],
    'Alliance': ['NDA', 'NDA', 'MGB', 'NDA', 'MGB', 'Others', 'NDA', 'NDA', 'MGB', 'MGB', 'Others', 'Others'],
    'Seats_Contested': [101, 101, 143, 28, 61, 'N/A', 6, 6, 20, 'N/A', 'N/A', 238],
    ...
    'Strike_Rate_Percentage': [88.1, 84.2, 17.5, 65.5, 9.8, 'N/A', 83.3, 66.7, 10.0, 'N/A', 'N/A', 0.0]
}
...
alliance_summary = {
    'Alliance': ['NDA', 'Mahagathbandhan', 'Others', 'Total'],
    'Seats_Won': [202, 35, 6, 243],
    'Vote_Share': ['46.6%', '37.9%', '15.5%', '100%'],
    'Components': ['BJP+JDU+LJP(RV)+HAM(S)+RLM', 'RJD+INC+CPI(ML)+CPI(M)', 'AIMIM+BSP+Others', 'All Parties']
}
...
women_stats = {
    ...
    'Success_Rate': ['83.3%', '76.9%', 'N/A', 'N/A', 'N/A', 'N/A', '32.9%']
}
...
# 8. Caste Demographics (from 2023 Bihar Caste Survey)
caste_demographics = {
    'Category': ['Extremely Backward Classes (EBC)', 'Other Backward Classes (OBC)', 'Scheduled Castes (SC)', 
                 'Scheduled Tribes (ST)', 'General/Upper Castes', 'Total'],
    'Population_Percentage': ['36.01%', '27.12%', '19.65%', '1.68%', '15.38%', '100%'],
    'Key_Communities': [
        '112 sub-castes including various groups',
        'Yadav, Kurmi, Koeri, Kushwaha, etc.',
        'Various Dalit communities',
        'Tribal communities',
        'Brahmin, Bhumihar, Rajput, Kayastha',
        'All communities'
    ]
}

caste_df = pd.DataFrame(caste_demographics)
print("Caste Demographics (Bihar 2023 Survey):")
print(caste_df.to_string(index=False))
print("\n" + "="*100 + "\n")
...
caste_df.to_csv('bihar_2025_caste_demographics.csv', index=False)
...
print("8. bihar_2025_caste_demographics.csv")
